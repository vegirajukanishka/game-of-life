    ...
    stages {   
        stage('Cloning Git') {
            ...
            node ('maven') {
                ...
                sh label:'',script: 'sudo docker run -d -p 8078:8080 --name kani13 gol.5'
            ...
            node ('docker') {
                    ...
                    sh label: '',script: 'sudo docker container run -d --name kani13 -p 8078:8080 kanishkaraju/raju:gol.5'
            }
        }     
        }
    }
